        ...
        return DefaultTabController(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              bottom: TabBar(
                controller: chatProvider.pageController, // You can connect this with TabController too
                onTap: (index) {
                  chatProvider.setCurrentIndex(newIndex: index);
                },
                tabs: const [
                  Tab(icon: Icon(Icons.history), text: 'Chat History'),
            ...
            body: TabBarView(
              controller: chatProvider.pageController, // Add PageController for the TabBarView
              children: _screens,
              physics: const NeverScrollableScrollPhysics(), // Disable swipe to change tabs if needed
            ),
          ),
        );
      },
