...
class AppRouter extends $AppRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(page: StudyPlanLandingPage.page),
        AutoRoute(page: LearningRourcesLanding.page),
        AutoRoute(page: PlannerLandingPage.page),
        AutoRoute(page: GradingSystem.page),
        AutoRoute(page: Learningpage.page),
        ...
        AutoRoute(page: DailySchedules.page),
        AutoRoute(page: WeeklySchedules.page),
        AutoRoute(page: MonthlySchedules.page),
        AutoRoute(page: SemesterSchedules.page),
